...
export function Revestimientos(){
    return(
        <div style={{paddingTop:'8rem', paddingBottom:'8rem'}} class="container-cards " >
            ...
            <Pileta img={assets.interior3} titulo= 'Interior 2' texto='Trabajos realizado en porcelanato' ruta='/NuestrosTrabajos/Interior3' />
            ...
            <Pileta img={assets.interiorn2} titulo= 'Interior 3' texto='Revestimiento interno de porcelanato' ruta='/NuestrosTrabajos/Interior2' />
